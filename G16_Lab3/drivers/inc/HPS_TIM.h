...
#define __HPS_TIM
	 ...
	 *The nature of the return value will depend on whether this
	 *function is able to read the S-bit value of multiple timers
	 *in the same call */
	extern int HPS_TIM_read_INT_ASM(HPS_TIM_t tim);

	/*Resets the S-bit and the F-bit
	 *This function should support multiple timers in the argument */
